...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        //|-------+-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------+-------|
                                           KC_LGUI,LOWER,  KC_ENT,    RCTL_T(KC_SPC),RAISE,KC_RALT
                                        //`-----------------------'  `-----------------------'
    ),
    [_LOWER] = LAYOUT_split_3x6_3(
        ...
        //|-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
           _______, KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,                     KC_NO,  KC_NO,  _______,_______,_______,KC_NO,
        //|-------+-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------+-------|
                                           KC_LGUI,LOWER,  _______,    KC_SPC, RAISE, _______
                                        //`-----------------------'  `-----------------------'
    ),
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        //|-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
           KC_F11, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,                     KC_MINS,KC_EQL, KC_LCBR,KC_RCBR,KC_PIPE,KC_GRV,
        //|-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
           KC_F12, KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,                    KC_UNDS,KC_PLUS,KC_LBRC,KC_RBRC,KC_BSLS,KC_TILD,
        //|-------+-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------+-------|
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        //,-----------------------------------------------.                  ,-----------------------------------------------.
           RESET,  RGBRST, KC_NO,  KC_NO,  KC_NO,  KC_NO,                     KC_NO,  KC_MUTE,KC_NO,  KC_NO,  KC_NO,  KC_NO,
        //|-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
           RGB_TOG,RGB_HUI,RGB_SAI,RGB_VAI,RGB_SPI,KC_NO,                     KC_PAUS,KC_VOLU,KC_NO,  KC_NO,  KC_NO,  KC_NO,
        //|-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
           RGB_MOD,RGB_HUD,RGB_SAD,RGB_VAD,RGB_SPD,KC_NO,                     KC_NO,  KC_VOLD,KC_NO,  KC_NO,  KC_NO,  RGB_RMOD,
        //|-------+-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------+-------|
                                           KC_LGUI,LOWER,  _______,   _______,RAISE,  _______
                                        //`-----------------------'  `-----------------------'
    )
